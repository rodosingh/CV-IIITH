...
import PIL.Image
import sys
from optical_flow import estimate
...
def main(davis_folder, save_dir):
    ...
    # save_dir = '/home2/rodosingh/AssignmentsProjects/CVProject/MATNet/data/DAVIS2017/DavisFlow'
...
def run(imagefile1, imagefile2, save_file):
	...
	flow_color = flow_to_color(tensorOutput.numpy().transpose(1,2,0), convert_to_bgr=True)
