...
# Data folder
__C.PATH.DATA = osp.abspath('/home2/rodosingh/AssignmentsProjects/CVProject/MATNet/data/DAVIS2017')

# Path to input images
__C.PATH.SEQUENCES = osp.join(__C.PATH.DATA, "JPEGImages", __C.RESOLUTION)

# Path to annotations
__C.PATH.ANNOTATIONS = osp.join(__C.PATH.DATA, "Annotations_unsupervised", __C.RESOLUTION)

__C.PATH.ANNOTATIONS_EDGE = osp.join(__C.PATH.DATA, "Annotations_edge",
                                     __C.RESOLUTION)

__C.PATH.FLOW = osp.join(__C.PATH.DATA, 'DavisFlow/')
